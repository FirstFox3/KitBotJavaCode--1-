...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    autoChooser.setDefaultOption("Taxi", Autos.taxi(driveSubsystem));
    autoChooser.addOption("Center L1 Score", Autos.taxiCenterScore(driveSubsystem, rollerSubsystem));
  ...
  private void configureBindings() {
    ...
    operatorController.leftBumper()
      .whileTrue(rollerSubsystem.runRoller(rollerSubsystem, () -> 0, () -> RollerConstants.ROLLER_EJECT_VALUE));
